...
void Shader::set3FloatVec(const std::string &name, std::vector<glm::vec3> &value) const
{
	glUniform3fv(glGetUniformLocation(ID, name.c_str()), value.size(), reinterpret_cast<GLfloat *>(value.data()));
}
